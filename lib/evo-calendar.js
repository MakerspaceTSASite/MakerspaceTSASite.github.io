...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        noEventForToday: "No event this day.",
                        noEventForThisDay: "No event this day.",
    ...
    EvoCalendar.prototype.buildTheBones = function() {
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            markup += '<div class="calendar-events">'+
                            '<div class="event-header"><p style="margin: 0 auto; width: 50%;"></p></div>'+
    ...
    EvoCalendar.prototype.buildEventList = function() {
        ...
        if(!hasEventToday) {
            ...
            if (_.$active.date === _.$current.date) {
                markup += '<p style="margin: 0 auto; width: 50%;">'+_.initials.dates[_.options.language].noEventForToday+'</p>';
            } else {
                markup += '<p style="margin: 0 auto; width: 50%;">'+_.initials.dates[_.options.language].noEventForThisDay+'</p>';
            }
            markup += '</div>';
        }
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup += '></div></div><div class="event-info"><p style="margin: 0 auto; width: 50%;" class="event-title">'+_.limitTitle(event_data.name);
        if (event_data.badge) markup += '<span>'+event_data.badge+'</span>';
        markup += '</p>'
        if (event_data.description) markup += '<p style="margin: 0 auto; width: 50%;" class="event-desc">'+event_data.description+'</p>';
        markup += '</div>';
        markup += '</div>';
        eventListEl.append(markup);
